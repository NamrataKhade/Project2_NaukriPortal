...
public class JobDAO {
	...
	public boolean addJobs(Jobs j) 
	{
	    ...
	    if(i==1)
	    {
	    	System.out.println("Job insert successfully !!!");
	    	f=true;
	    }
	...
	// 
		...
		public boolean updateJob(Jobs j) {
		    ...
		    if(i==1)
		    {
		    	System.out.println("Job Update successfully !!!");
		    	f=true;
		    }
		...
		public List<Jobs> getJobsORAndLocationAndCate(String category,String location){
			
			List<Jobs> list=new ArrayList<Jobs>();
			Jobs j=null;
			try {
				String sql="select * from jobs where category=? location or order by id desc";
				PreparedStatement ps=conn.prepareStatement(sql);
...
public List<Jobs> getJobsAndLocationAndCate(String category,String location){
			...
			Jobs j=null;
			try {
				String sql="select * from jobs where category=? location and order by id desc";
				PreparedStatement ps=conn.prepareStatement(sql);
